...
We release our pretrain model in [here](https://drive.google.com/file/d/1-Xx2rwf-hG4Wt1FMH3K-rmATWroDTTPe/view?usp=sharing). Since our model is a Chinese character-based model, arbitrary SentencePiece model can be used during the inference phase. We provide a SentencePiece model in [here](https://drive.google.com/file/d/1-w-K-IDFMc29kiUTQ6FKtAZB2NfVp2VE/view?usp=sharing), which is trained on Chinese wiki data.
