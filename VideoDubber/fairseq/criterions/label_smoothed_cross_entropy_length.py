...
@register_criterion(
    "label_smoothed_cross_entropy_length",
    dataclass=LabelSmoothedCrossEntropyCriterionConfig,
)
class LabelSmoothedCrossEntropyLengthCriterion(LabelSmoothedCrossEntropyCriterion):
    def forward(self, model, sample, reduce=True):
        ...
        net_output, length_output = model(src_tokens, src_lengths, prev_output_tokens, tgt_tokens)
