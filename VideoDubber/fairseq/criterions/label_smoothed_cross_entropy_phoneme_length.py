...
@register_criterion(
    "label_smoothed_cross_entropy_phoneme_length",
    dataclass=LabelSmoothedCrossEntropyCriterionConfig,
)
class LabelSmoothedCrossEntropyPhonemeLengthCriterion(LabelSmoothedCrossEntropyCriterion):
    def forward(self, model, sample, reduce=True):
        ...
        """
        src_tokens, src_lengths, prev_output_tokens,src_phoneme_lengths,tgt_phoneme_lengths = (
            sample["net_input"]["src_tokens"],
            sample["net_input"]["src_lengths"],
            sample["net_input"]["prev_output_tokens"],
            sample["src_phoneme_lengths"],
            sample["tgt_phoneme_lengths"],
        )
        tgt_tokens = sample["target"]
       
        net_output, length_output = model(src_tokens, src_lengths, prev_output_tokens, tgt_tokens,src_phoneme_lengths,tgt_phoneme_lengths)
